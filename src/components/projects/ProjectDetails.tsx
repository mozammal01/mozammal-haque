    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
        ...
        <div className="lg:col-span-8 space-y-8">
          {/* Overview Card */}
          <div className="relative overflow-hidden rounded-2xl border border-black/5 dark:border-white/5 bg-white dark:bg-slate-900/40 p-6 md:p-8 backdrop-blur-md shadow-2xl">
            <div className="absolute top-0 left-0 w-1.5 h-full bg-primary"></div>
            <h3 className="text-2xl font-extrabold text-slate-900 dark:text-white mb-4 tracking-wider uppercase flex items-center gap-2">
          ...
          {features && features.length > 0 && (
            <div className="relative overflow-hidden rounded-2xl border border-black/5 dark:border-white/5 bg-white dark:bg-slate-900/40 p-6 md:p-8 backdrop-blur-md shadow-2xl">
              ...
              <h3 className="text-2xl font-extrabold text-slate-900 dark:text-white tracking-wider mb-6 flex items-center gap-2 uppercase">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {features.map((feature) => (
                  <div
                    key={feature.id}
                    className="group flex items-start space-x-4 p-4 rounded-xl border border-black/5 dark:border-white/5 bg-slate-50 dark:bg-slate-950/20 hover:bg-slate-100 dark:hover:bg-slate-900/50 transition-all duration-300 hover:translate-y-[-2px] hover:shadow-lg"
                  >
                    ...
                    <p className="text-slate-600 dark:text-slate-300 font-medium leading-relaxed group-hover:text-slate-900 dark:group-hover:text-white transition-colors duration-300">
                      {feature.content}
                    </p>
                  </div>
                ))}
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <PremiumCard className="w-full h-full">
            <div className="space-y-6 w-full">
              <h4 className="text-xl font-bold text-slate-900 dark:text-white tracking-wider uppercase border-b border-black/10 dark:border-white/10 pb-4">
                Case Study Specs
              </h4>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between py-2 border-b border-black/5 dark:border-white/5">
                  ...
                  <span className="text-sm font-bold text-slate-800 dark:text-white">Full-Stack Developer</span>
                </div>
                ...
                <div className="flex items-center justify-between py-2 border-b border-black/5 dark:border-white/5">
                  ...
                  <span className="text-sm font-bold text-slate-800 dark:text-white">Web Application</span>
                </div>
                ...
                <div className="flex items-center justify-between py-2 border-b border-black/5 dark:border-white/5">
                  ...
                  <span className="text-sm font-bold text-slate-800 dark:text-white">4 Weeks</span>
                </div>
      ...
      {((images1 && images1.length > 0) || (images2 && images2.length > 0)) && (
        <div className="space-y-10 pt-10">
          <div className="text-center space-y-3">
            ...
            <h3 className="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white tracking-wide uppercase">
              Interactive Showcase
            </h3>
            <p className="text-slate-600 dark:text-slate-400 max-w-xl mx-auto text-sm md:text-base font-medium">
              Swipe or click on the card decks below to view various dashboard modules and pages in full detail.
            </p>
          </div>
          <div className="bg-white dark:bg-slate-950/20 border border-black/5 dark:border-white/5 rounded-3xl p-6 md:p-10 backdrop-blur-md">
      ...
      {filteredSkills && filteredSkills.length > 0 && (
        <div className="space-y-6 pt-10">
          ...
          <div className="bg-white dark:bg-slate-950/20 border border-black/5 dark:border-white/5 rounded-3xl p-4 md:p-8 backdrop-blur-md">
