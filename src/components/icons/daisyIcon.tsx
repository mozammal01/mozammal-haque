...
export default function DaisyIcon({...props }: IconProps) {
  return (
    <svg aria-label="daisyUI logomark" viewBox="0 0 450 450" fill="none" xmlns="http://www.w3.org/2000/svg" width={props.size} height={props.size} {...props}>
      <g data-name="bg">
        <g opacity="0.7">
          <path
