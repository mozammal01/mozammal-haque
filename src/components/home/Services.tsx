        ...
        <div className="flex flex-col gap-24 md:gap-[50vh] max-w-5xl mx-auto">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <div className={`relative bg-gradient-to-br from-primary/10 via-[#0a0a0a]/95 to-black/95 backdrop-blur-2xl border border-primary/10 rounded-[2rem] p-6 md:p-10 shadow-[0_30px_100px_rgba(0,0,0,0.8)] w-full max-w-[1000px] flex flex-col ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'} items-center gap-10 md:gap-16 overflow-hidden group`}>
                  ...
                  <div className="w-full md:w-1/2 h-64 md:h-[380px] relative flex items-center justify-center bg-gradient-to-br from-[#111111] to-black rounded-2xl border border-primary/5 overflow-hidden group-hover:border-primary/20 transition-colors duration-500 shadow-inner">
                    {/* Decorative Circles */}
                    ...
                    {/* Glowing Icon Frame */}
                    <div className="relative z-10 w-32 h-32 md:w-48 md:h-48 drop-shadow-[0_0_30px_rgba(var(--primary-rgb, 255,193,7),0.2)] group-hover:scale-110 group-hover:-translate-y-2 transition-all duration-700">
                      <Image
                  ...
                  <div className="w-full md:w-1/2 flex flex-col text-center md:text-left py-4">
                    ...
                    <h3 className="text-3xl md:text-4xl lg:text-[40px] font-extrabold text-primary mb-6 leading-[1.1] tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/70">
                      {service.name}
                    </h3>
                    ...
                    {/* Bottom Footer Link */}
                    <div className="mt-auto flex items-center justify-center md:justify-start text-xs text-slate-400 font-medium pt-4 border-t border-white/5 group-hover:text-primary transition-colors duration-300">
          ...
          <motion.div
            ...
            style={{
              top: `calc(15vh + ${services.length * 30}px)`,
              zIndex: services.length
            }}
          >
            <div className="relative bg-gradient-to-br from-primary/10 via-[#0a0a0a]/95 to-primary/5 backdrop-blur-3xl border border-primary/30 rounded-[2.5rem] p-10 md:p-16 shadow-[0_0_100px_rgba(var(--primary-rgb, 255,193,7),0.1)] w-full max-w-[1000px] min-h-[600px] flex flex-col items-center justify-center text-center overflow-hidden group">
              ...
              <div className="relative z-10">
                <span className="px-6 py-2 text-sm font-bold tracking-widest uppercase bg-primary/10 text-primary rounded-full border border-primary/20 mb-8 inline-block shadow-[0_0_20px_rgba(var(--primary-rgb, 255,193,7),0.1)]">
                  What's Next?
                </span>
                
                <h3 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 leading-tight tracking-tight">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                  <a href="#contact" className="px-8 py-4 bg-primary text-slate-900 font-bold rounded-xl text-lg hover:bg-white hover:scale-105 transition-all duration-300 shadow-[0_0_30px_rgba(var(--primary-rgb, 255,193,7),0.3)]">
                    Let's Work Together
                  </a>
                  <a href="#projects" className="px-8 py-4 bg-transparent text-white font-bold rounded-xl text-lg border border-white/20 hover:bg-white/10 hover:border-primary/40 transition-all duration-300">
                    View My Work
                  </a>
                </div>
              </div>
